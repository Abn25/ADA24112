            ...
            ctx.drawImage(ground, 0, 0, 300, 300); // حجم الصورة
                ...
                jimp.read(url, (err, ava) => {
                    ...
                    ctx.font = 'bold 13px Comic Sans MS'; // حجم الخط و نوعه
                        ...
                        ctx.textAlign = "center"; // محاذا ة النص
                        ctx.fillText(`$${profile[getvalueof.id].credits}`, 82, 159) // احداثيات المصاري
                        ...
                        ctx.fillStyle = "#f1f1f1" // لون الخط
                        ctx.textAlign = "center"; // محاذا ة النص
                        ctx.fillText(`${profile[getvalueof.id].level}`, 225, 114) // احداثيات اللفل
                        ...
                        ctx.fillStyle = "#f1f1f1" // لون الخط
                        ctx.textAlign = "center"; // محاذا ة النص
                        ctx.fillText(`${profile[getvalueof.id].tite}`, 155, 197) // احداثيات النقاط
                        ...
                        ctx.fillStyle = "#f1f1f1";
                        ctx.textAlign = "center";
                        ctx.fillText(`+${profile[getvalueof.id].rep}`, 80,113)
...
ava.src = buf;
                        ...
                        ctx.closePath();
                        ctx.clip();
                          ctx.drawImage(ava, 116, 80, 74, 74);
...
client.on('message',async message => { // تعريف ال message
    ...
    let devs = ["",""]; // هنا تحط ايدي الديف الي مسموح لهم بـ زياده الكريدتس
